...
"/* Список водоизмещений (посадок) на кренование\n"
...
Ok: FileName=strdup( strcpy( Name,fname( Name ) ) );
  ...
  Simple_Hull( Nx,Nz,Nz );               // файл создавался и сразу считывался
  if( !strcmp( Name,"Hull.vsl" ) )strncpy( Name,MIDV+74,107 ),
                                  strncpy( Name+107,MIDV+184,111 ),Name[218]=0;
//
