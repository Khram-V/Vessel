...
void Surface::EditMenu( Window *Win ) // обращение последовательности обхода рёбер по граням
{ Vector Afins={1,1,1},Shift={0,0,0};
  Mlist Menu[]={ { 1,0," Смещение и масштабирование корпуса" }             // 0
  , { 2,6," Сдвиг  x:%6.3lf",&Shift.x},{0,6,", y:%6.3lf",&Shift.y},{0,6,", z:%6.3lf",&Shift.z}
  , { 1,6,"Масштаб x:%6.3lf",&Afins.x},{0,6,", y:%6.3lf",&Afins.y},{0,6,", z:%6.3lf",&Afins.z}
  };
