...
//  U.z = iV*Length/Breadth;
//  U = ( vB*U.z + Gravity*Volume )/( U.z+Volume );
//  Route+=( Locate+=Matrix(*this)*( (V-W*U)*Ts ) ); // +Matrix(*this)*Gravity;
  Route+=( Locate += Matrix(*this)*( V*Ts ) ); // +Matrix(*this)*Gravity;
