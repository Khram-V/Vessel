...
//Start_Experiment();    /// !!! - считывание конфигурационного файла !!!
  ...
  omp_set_nested( true );
#endif
  Sea.SetTimer( 50 );     // вычисления по волнению с механикой корабля (½ сек)
  Ship.SetTimer( 500,Hull_and_Waves_Draw );       // изображение корабля и моря
...
//  Sleep( 1025 );      // или варианты полной задержки по блокирующему таймеру
