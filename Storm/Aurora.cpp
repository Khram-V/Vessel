...
Hull::Hull():Base(),View// в прицепе View окошко графической визуализации OpenGL
...
{ Vessel=this;                  // ссылка на корпус, пусть будет внешний доступ
  Nframes=Mid=0; Length=Breadth=Draught=1.0; vC=vR=vS=vP=Zero;
...
//                .Print( -3,0,"©75 Василий Храмушин" ).Save().Show();
...
//#include "../Window/Sym_CCCP.c"
  ...
  color( green ); AlfaBit( _8x08 ).Print( 2,8,"©1975-2024" )
                 .AlfaBit( _8x14 ).Print( " Калининград - Сахалин - יְרוּשָׁלַיִם\n\n" );
...
//Start_Experiment();    /// !!! - считывание конфигурационного файла !!!
  ...
  Ship.SetTimer( 600,Hull_and_Waves_Draw );       // изображение корабля и моря
