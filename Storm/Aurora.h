...
//#define FramePost 0xE0000000    // общая маска к особому шпангоутному индексу
                                  //
extern Real Ts;                   // расчётный интервал на текущем времени Math
...
const Real eps = 0.00001,         // 0.01 мм - допустимое сближение точек
...
//private:
  ...
  void DampInit(); // инициализация коэффициентов демпфирования по шагу времени
  //
...
void logDamp();   // факторы демпфирования смещений и угловой качкеи
