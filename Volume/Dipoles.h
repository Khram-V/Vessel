...
const int                  /// блок исходных констант - параметров эксперимента
      Dipole_route=496,    // длина истории в отсчётах визуализуемого маршрута
...
{ unsigned Grid: 2,  // признак разметки континуальной пространственной сетки
          ...
          Model: 2,  // признак раскраски или контуров диполя
           ...
           Size: 1;  // изменчивость размеров по разности скоростей и моментов
                     // ≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈
  status():          // одна частичка не сильно грузит вычислительные процессы
    Grid( 1 ),Field( 3 ),Model( 3 ),Edge( 1 ),
    Body( true ),Flow( false ),Size( false ){}
} ex;
struct Dipole
...
struct Dipoles        // пространство континуально-корпускулярного эксперимента
...
public:               // бесконтрольный доступа к свободным частицам ограничен
 ...
 Dipole& operator[]( int k ){ return D[k]; }  // бесконтрольный доступ к диполю
...
extern unsigned nDip,           // количество корпускул в активном эксперименте
                ...
                Video_count;    // с выделением графических прорисовок
