#ifndef __Type_h__
#define __Type_h__           //! подборка констант и математических операций
#include <math.h>            //  ¯¯¯¯¯¯¯¦є∈∃∪∩⊊⊆⊂⊃⊇⊋∅⊕⊗∜∛√ ±÷≈×⨉ ∆∇∀˂˃˄˅∧∨⋀⋁ ⌃⌄
#include <stdlib.h>          // ‘’„“”«»‹›⎖⦁•∙≥≤≡≠∂δ⇒⇯⇐⇔↦←↑→↓↔↕↨∏∑∩∫ƒæϑ Θ§µ₪א©®™
...
//tring& operator << ( const Real );  // до 4 вряд R:9:4 без превышения ширины
