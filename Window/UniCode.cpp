...
char* UtC( unsigned &c, const char *V ) // синтез Unicode из полноценного UTF-8
...
{ char *s=(char*)str; unsigned u=0; wchar_t *w=(wchar_t*)( (char*)LS ),*v=w;
  while( *s ){ s=UtC( u,s ); *w++=wchar_t( u ); } *w=0; return v;
}
#else
#include <windows.h>
//
